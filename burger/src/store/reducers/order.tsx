...
const reducer = (state = initialState, action: actionTypes.UActions) => {
  switch (action.type) {
    case actionTypes.EnumActionTypes.PURCHASE_INIT:
      return purchaseInit(state);
    case actionTypes.EnumActionTypes.PURCHASE_BURGER_START:
      return purchaseBurgerStart(state);
    case actionTypes.EnumActionTypes.PURCHASE_BURGER_SUCCESS:
      return purchaseBurgerSuccess(state, action);
    case actionTypes.EnumActionTypes.PURCHASE_BURGER_FAIL:
      return purchaseBurgerFail(state);
    case actionTypes.EnumActionTypes.FETCH_ORDERS_START:
      return fetchOrdersStart(state);
    case actionTypes.EnumActionTypes.FETCH_ORDERS_SUCCESS:
      return fetchOrdersSuccess(state, action);
    case actionTypes.EnumActionTypes.FETCH_ORDERS_FAIL:
